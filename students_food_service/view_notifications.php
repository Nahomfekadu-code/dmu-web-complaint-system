...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['notification_id'])) {
    ...
    if ($notification_id) {
        ...
        if ($update_stmt) {
            $update_stmt->bind_param("ii", $notification_id, $food_service_id);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['mark_all_read'])) {
    ...
    if ($update_all_stmt) {
        $update_all_stmt->bind_param("i", $food_service_id);
...
");
if ($notif_query) {
    $notif_query->bind_param("i", $food_service_id);
    $notif_query->execute();
    $notifications = $notif_query->get_result();
    error_log("Notifications fetched for food_service_id=$food_service_id: " . $notifications->num_rows . " rows");
    $notif_query->close();
} else {
