...
// Fetch complaints assigned to the Students Food Service user
$complaints = [];
$sql_complaints = "
    ...
    WHERE e.escalated_to_id = ? AND e.escalated_to = 'students_food_service'
    ORDER BY e.created_at DESC";
$stmt_complaints = $db->prepare($sql_complaints);
if ($stmt_complaints) {
    $stmt_complaints->bind_param("i", $food_service_id);
    $stmt_complaints->execute();
    $result_complaints = $stmt_complaints->get_result();
    while ($row = $result_complaints->fetch_assoc()) {
        $complaints[] = $row;
    }
    error_log("Complaints fetched for food_service_id=$food_service_id: " . print_r($complaints, true));
...
<head>
    ...
    <title>Students Food Service Dashboard - DMU Complaint System</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-container">
            <h2>Students Food Service Dashboard</h2>
