...
// Fetch complaint details (complaints escalated or assigned to this Academic VP)
$stmt = $db->prepare("
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        if ($action === 'resolve') {
            ...
            $additional_info = "Resolved by Academic Vice President: $decision_text";
            ...
            // Send stereotyped report to the President
            $additional_info = "Escalated by Academic Vice President: $decision_text";
