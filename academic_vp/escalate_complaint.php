...
// Fetch complaint details (only complaints escalated to this Academic VP)
$stmt = $db->prepare("
    ...
    WHERE c.id = ? AND e.id = ? AND e.escalated_to = 'academic_vp' 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $notification_desc = "Complaint #$complaint_id has been escalated to the President by the Academic Vice President: $decision_text";
...
<head>
    ...
    <title>Escalate Complaint #<?php echo $complaint_id; ?> | Academic VP | DMU Complaint System</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <footer class="main-footer">
            © <?php echo date("Y"); ?> DMU Complaint Management System | Academic Vice President Panel
        </footer>
    </div>
