...
// Fetch resolved complaints where the University Registrar was involved
$complaints = [];
$resolved_query = "
    SELECT DISTINCT c.id, c.title, c.category, c.status, c.created_at, c.resolution_date
    FROM complaints c
...
if ($unread_stmt) {
    $unread_stmt->bind_param("i", $registrar_id);
    $unread_stmt->execute();
...
<head>
    ...
    <title>Resolved Complaints | University Registrar - DMU Complaint System</title>
        ...
        <div class="content-container">
            ...
            <div class="table-container">
                <?php if (empty($complaints)): ?>
                    <p class="no-complaints">No resolved complaints at this time.</p>
                <?php else: ?>
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php foreach ($complaints as $complaint): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="view_complaint.php?complaint_id=<?php echo $complaint['id']; ?>&from=resolved" class="action-btn btn-view">
