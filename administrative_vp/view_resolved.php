...
// Fetch Administrative VP details (Needed for the navigation bar)
...
if ($stmt_vp) {
    ...
    if ($result_vp->num_rows > 0) {
        ...
        error_log("Administrative Vice President details not found for ID: " . $vp_id);
    }
    $stmt_vp->close();
} else {
...
// Fetch resolved complaints where the Administrative VP was involved
$stmt = $db->prepare("
    ...
    <nav class="vertical-nav">
        <div class="nav-header">
            ...
            <div class="user-profile-mini">
                <i class="fas fa-user-tie"></i>
                <div class="user-info">
                    <h4>Administrative VP</h4>
                    <p>Role: Administrative Vice President</p>
                </div>
            </div>
            <?php endif; ?>
        </div>
    ...
    <div class="main-content">
        ...
        <div class="content-container">
            ...
            <?php if (isset($_SESSION['success'])): ?>
                <div class="alert alert-success"><i class="fas fa-check-circle hypnotic"></i> <?php echo htmlspecialchars($_SESSION['success']); unset($_SESSION['success']); ?></div>
            <?php endif; ?>
