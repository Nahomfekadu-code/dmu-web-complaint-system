...
// Fetch notifications related to the complaint for the Administrative VP
$notifications_query = "
    SELECT n.*
...
<head>
    ...
    <title>View Complaint #<?php echo htmlspecialchars($complaint_id); ?> | Administrative VP | DMU Complaint System</title>
        ...
        <div class="content-container">
            ...
            <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                ...
                <?php if ($complaint['status'] != 'resolved' && $complaint['status'] != 'rejected'): ?>
                    ...
                    <a href="decide_complaint.php?complaint_id=<?php echo htmlspecialchars($complaint_id); ?>" class="btn btn-primary"><i class="fas fa-gavel"></i> Decide Complaint</a>
                <?php endif; ?>
            </div>
        </div>
