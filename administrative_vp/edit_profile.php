...
if ($stmt_vp) {
    ...
    $_SESSION['error'] = "Database error fetching administrative vp details.";
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($_SESSION['error'])) {
        ...
        try {
            ...
            // Commit and show success if something was changed
    ...
    <nav class="vertical-nav">
        <div class="nav-header">
            ...
            <div class="user-profile-mini">
                <i class="fas fa-user-tie"></i>
                <div class="user-info">
                    <h4>Administrative Vice President</h4>
                    <p>Role: Administrative VP</p>
                </div>
            </div>
            <?php endif; ?>
        </div>
