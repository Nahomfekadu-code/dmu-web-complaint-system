...
// Fetch escalation history (only where Human Resource Management is involved)
$escalations = [];
$escalation_query = "
...
if ($escalation_stmt) {
    $escalation_stmt->bind_param("ii", $complaint_id, $hrm_id);
...
<head>
    ...
    <title>View Complaint #<?php echo htmlspecialchars($complaint['id']); ?> | Human Resource Management - DMU Complaint System</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-container">
            ...
            <?php else: ?>
                <div class="alert alert-info"><i class="fas fa-info-circle"></i> No escalation history found for this complaint involving the Human Resource Management.</div>
            <?php endif; ?>
