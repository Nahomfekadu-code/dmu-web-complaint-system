...
$hrm = null; // Initialize $hrm

// Fetch Human Resource Management details (Needed for the navigation bar)
...
if ($stmt_hrm) {
    ...
    if ($result_hrm->num_rows > 0) {
        ...
        error_log("Human Resource Management details not found for ID: " . $hrm_id);
...
// Fetch resolved complaints where the Human Resource Management was involved
$stmt = $db->prepare("
        ...
        <div class="nav-header">
            ...
            <div class="user-profile-mini">
                ...
                <div class="user-info">
                    ...
                    <p>Role: Human Resource Management</p>
                </div>
            </div>
            <?php endif; ?>
        </div>
