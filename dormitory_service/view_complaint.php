...
// Fetch Dormitory Service user details
...
// Check if the complaint is accessible to the dormitory service user
$access_check_query = "
    SELECT c.id
    FROM complaints c
...
$stmt_access->bind_param("iiiii", $complaint_id, $user_id, $user_id, $user_id, $user_id);
$stmt_access->execute();
$access_result = $stmt_access->get_result();
if ($access_result->num_rows == 0) {
    error_log("Access denied for complaint ID: $complaint_id, user_id: $user_id");
