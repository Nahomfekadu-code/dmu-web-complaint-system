...
// Fetch resolved complaints where the Dormitory Service was involved
$stmt = $db->prepare("
    ...
    WHERE e.escalated_to = 'dormitory_service'
...
if ($stmt) {
    ...
    error_log("Resolved complaints fetched for dorm_id=$dorm_id: " . $resolved_complaints->num_rows . " rows");
    $stmt->close();
} else {
