...
// Role check: Ensure the user is logged in and is a 'cost_sharing'
...
$stmt_complaint_details = $db->prepare("
    ...
    WHERE c.id = ?
      AND e.id = ?
      AND e.escalated_to = 'cost_sharing'
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $res_detail = "Escalated to Campus Registrar by Cost Sharing. Reason: " . $reason_text;
            ...
            $registrar_notification_desc = "Complaint #$complaint_id has been escalated to you by Cost Sharing for review. Reason: $reason_text";
            ...
            if ($escalator_id && $escalator_id != $user_id) {
                $handler_notification_desc = "Complaint #$complaint_id, which you escalated, has been further escalated by Cost Sharing to the Campus Registrar. Reason: $reason_text";
    ...
    <nav class="vertical-nav">
        <div class="nav-header">
            ...
            <div class="user-profile-mini">
                <i class="fas fa-user-tie"></i>
                <div class="user-info">
                    <h4>Cost Sharing User</h4>
                    <p>Role: Cost Sharing</p>
                </div>
            </div>
            <?php endif; ?>
        </div>
